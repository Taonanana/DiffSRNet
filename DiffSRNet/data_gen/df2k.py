...
if __name__ == '__main__':
    ...
    train_img_list = []
    train_img_list += sorted(glob.glob('data/raw/Flickr2K/SLA_test_HR/*.png'))
    train_img_list += sorted(glob.glob('data/raw/DIV2K/SLA_train_HR/*.png'))
    test_img_list = sorted(glob.glob('data/raw/DIV2K/SLA_valid_HR/*.png'))
